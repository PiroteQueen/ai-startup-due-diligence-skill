...
| 模型供应商依赖 | model_dependency | medium | 多模型含 Mistral；其他模型细节有限 | known/unknown | provider agreements、routing |
| 法律内容控制 | distribution_dependency | high | incumbent 掌握 Westlaw/Lexis 内容 | known | 许可与替代路线 |
| 幻觉/责任事故 | legal_data | high | 高风险法律输出 | unknown | incident、eval、保险 |
| 竞争快速同质化 | market | high | Legora、CoCounsel、Lexis+ 功能趋同 | known | win/loss 与 benchmark |
